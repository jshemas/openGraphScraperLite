...
const doesElementExist = (selector, attribute, $) => {
    var _a;
    return ($(selector).attr(attribute) && (((_a = $(selector).attr(attribute)) === null || _a === void 0 ? void 0 : _a.length) || 0) > 0);
};
/**
 * ogs fallbacks
 *
...
function fallback(ogObject, options, $, body) {
    ...
    if (!ogObject.ogTitle) {
        ...
        else if ($('head > meta[name="title"]').attr('content') && (((_a = $('head > meta[name="title"]').attr('content')) === null || _a === void 0 ? void 0 : _a.length) || 0) > 0) {
    ...
    if (!ogObject.ogImage) {
        ...
        $('img').map((index, imageElement) => {
            ...
            if (!(0, utils_1.isUrlValid)(source, utils_1.defaultUrlValidatorSettings) || !(0, utils_1.isImageTypeValid)(type))
                return false;
            const fallbackImage = {
                url: source,
                type,
            ...
            (_a = ogObject.ogImage) === null || _a === void 0 ? void 0 : _a.push(fallbackImage);
            return false;
        });
